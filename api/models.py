...
class ItemBatch(models.Model):
    item = models.ForeignKey(Item, on_delete=models.CASCADE, related_name="itemBatch")
    expiryDate = models.DateField()
    quantity = models.IntegerField()

class ItemNotices(models.Model):
    item = models.ForeignKey(Item, on_delete=models.CASCADE, related_name="itemNotices")
...
class ItemOrder(models.Model):
    ...
    orderRequester = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
...
class ItemActivityLog(models.Model):
    ...
    item = models.ForeignKey(Item, on_delete=models.CASCADE, related_name="itemActivity")
